...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reason', models.CharField(blank=True, default=None, max_length=300, null=True)),
                ('date_incurred', models.DateTimeField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('infraction', models.CharField(choices=[('CC', 'Cutting_Class'), ('T', 'Tardy'), ('A', 'Absence')], default=None, max_length=13)),
