...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('infraction', models.CharField(blank=True, choices=[('CC', 'Cutting Class'), ('T', 'Tardy'), ('A', 'Absence')], default=None, max_length=13, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_time_out', models.DateTimeField(blank=True, null=True)),
                ('afternoon_time_in', models.DateTimeField(blank=True, null=True)),
                ('afternoon_time_out', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('infraction', models.CharField(choices=[('CC', 'Cutting Class'), ('T', 'Tardy'), ('A', 'Absence')], default=None, max_length=13)),
                ('reason', models.CharField(default=None, max_length=300)),
                ('date_filed', models.DateTimeField(auto_now_add=True)),
                ('date_incurred', models.DateTimeField()),
                ('excused', models.BooleanField(default=False)),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='person_profiling.Teacher')),
